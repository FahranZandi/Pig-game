...
const init = () => {
    ...
    document.getElementById("section-0").classList.remove("player-winner", "player-active");
    document.getElementById("section-1").classList.remove("player-winner", "player-active");
